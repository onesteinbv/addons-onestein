...
class ProjectIssueStage(models.Model):
    ...
    legend_done = fields.Char(
        ...
        translate=True,
        help='Override the default value displayed for the done state for kanban selection, when the issue is in that stage.')
    legend_normal = fields.Char(
        string='Kanban Ongoing Explanation',
        translate=True,
        help='Override the default value displayed for the normal state for kanban selection, when the issue is in that stage.')
    fold = fields.Boolean(
